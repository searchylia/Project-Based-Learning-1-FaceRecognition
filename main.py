...
def run(imagePath, samplePath, threshold):
    images_path = imagePath
    sample_path = samplePath
    ...
    resultPath, matchPercentage = eigenface2.recogniseUnknownFace(
        images_path, sample_path, datasetMean, datasetProjectionMat, weightDataset, threshold
    )
